  ...
  var x = function(e) {
      ...
      return o(t, [{
          ...
          value: function() {
              var e = this;
              // here
              w.innerHTML = w_html(this._length);
      ...
      ss = function(e) {
          ...
          function t() {
              ...
              if (urlParams.has("s")) {
                ...
                if (querySolution.length < 2) {
                  console.error("invalid word in querystring, length must be at least 2")
                  querySolution = null
                }
          ...
          return o(t, [{
              key: "evaluateRow",
              value: function() {
                  if (this.solution.length === this.tileIndex && !(this.rowIndex >= 6)) {
              ...
              key: "addLetter",
              value: function(e) {
                  this.gameStatus === Qa && (this.canInput && (this.tileIndex >= this.solution.length || (this.boardState[this.rowIndex] += e, this.$board.querySelectorAll("game-row")[this.rowIndex].setAttribute("letters", this.boardState[this.rowIndex]), this.tileIndex += 1)))
              }
          }, {
              key: "removeLetter",
              value: function() {
              ...
              value: function() {
                  if (this.gameStatus === Qa && this.canInput) {
                      if (this.solution.length !== this.tileIndex) return this.$board.querySelectorAll("game-row")[this.rowIndex].setAttribute("invalid", ""), void this.addToast("Non abbastanza lettere");
                      this.evaluateRow()
                  }
              }
          }, {
              ...
              value: function() {
                  // here
                  var l = this.solution.length;
                  var e = this.shadowRoot.querySelector("#board-container"),
                      a = Math.min(Math.floor(e.clientHeight * (l / 6)), 350),
                      s = 6 * Math.floor(a / l);
              ...
              value: function() {
                  ...
                  for (var a = 0; a < 6; a++) {
                      ...
                      // here
                      s.setAttribute("letters", this.boardState[a]), s.setAttribute("length", this.solution.length), this.evaluations[a] && (s.evaluation = this.evaluations[a]), this.$board.appendChild(s)
                  }
